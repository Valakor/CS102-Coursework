...
public:
	...
	User(int id, std::string name, int age, int zip);	// Constructor that creates a User with given 'id', 'name', 'age', and 'zip'
	int getId() const;									// Returns the 'id_' of the current user
	std::string getName() const;						// Returns the 'name_' of the current user
